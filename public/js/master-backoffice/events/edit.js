 ...
 */
var formsComponent = __webpack_require__(517);
...
this.start = function () {
  if (!_isInit) {
    console.log("Edit Event area started..");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Forms_vue__ = __webpack_require__(518);
...
/* scopeId */
var __vue_scopeId__ = "data-v-178d52ea"
/* moduleIdentifier (server only) */
...
Component.options.__file = "resources/assets/js/components/forms/request/backoffice/events/edit/Forms.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-178d52ea", Component.options)
  } else {
    hotAPI.reload("data-v-178d52ea", Component.options)
' + '  }
...
var update = __webpack_require__(3)("4704d97c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-178d52ea\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Forms.vue", function() {
     var newContent = require("!!../../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-178d52ea\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Forms.vue");
...
// module
exports.push([module.i, "\n.btn.disabled[data-v-178d52ea], .btn[disabled][data-v-178d52ea], fieldset[disabled] .btn[data-v-178d52ea] {\n    cursor: auto;\n}\n.form-group .help-block[data-v-178d52ea] {\n    display: block;\n}\nspan.check[data-v-178d52ea]::after {\n    -webkit-animation: unset!important;\n            animation: unset!important;\n}\nspan.check form-control[data-v-178d52ea]::after {\n    -webkit-animation: unset!important;\n            animation: unset!important;\n}\n@media (max-width: 480px), (max-width: 767px) {\n.form-group .form-control[data-v-178d52ea] {\n        width: 100% !important;\n}\n}\n.card.card-shadow[data-v-178d52ea] {\n    -webkit-box-shadow: 0 12px 20px -10px rgba(0, 0, 0, 0.12),\n    0 4px 20px 0px rgba(0, 0, 0, 0.12),\n    0 7px 8px -5px rgba(0, 0, 0, 0.12)!important;\n\n    box-shadow: 0 12px 20px -10px rgba(0, 0, 0, 0.12),\n    0 4px 20px 0px rgba(0, 0, 0, 0.12),\n    0 7px 8px -5px rgba(0, 0, 0, 0.12)!important;\n}\n\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        checkValidDate: function checkValidDate() {
            ...
            if (date.dateFrom > date.dateTo || date.dateFrom === 'Invalid date' || date.dateTo === 'Invalid date') {
        ...
        setEventToEdit: function setEventToEdit(response) {
        ...
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
            ...
            _c("div", { staticClass: "modal-body text-center" }, [
              _vm.success
                ? _c("p", [_vm._v("The event was successfully edited")])
                    ...
                    _c("div", { staticClass: "col-md-6" }, [
                      _c(
                        "div",
                        {
                          ...
                          class: {
                            "has-error": _vm.errors.has(_vm.payload.title.value)
                          }
                        },
                        [
                          _c("label", [
                            _vm._v(_vm._s(_vm.payload.title.label))
                          ]),
                          _vm._v(" "),
                          _c(
                            "p",
                            {
                              ...
                              attrs: { id: "trans-title" }
                            },
                            [_vm._v(_vm._s(_vm.trans(_vm.payload.title.post)))]
                          ),
                          _vm._v(" "),
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.payload.title.post,
                                expression: "payload.title.post"
                              },
                              { name: "validate", rawName: "v-validate" }
                            ],
                            staticClass: "input form-control",
                            attrs: {
                              name: _vm.payload.title.value,
                              "data-vv-rules": _vm.payload.title.rules,
                              "data-vv-validate-on": _vm.validateForm,
                              type: "text"
                            },
                            domProps: { value: _vm.payload.title.post },
                            on: {
                              ...
                              directives: [
                                {
                                  ...
                                  rawName: "v-show",
                                  value: _vm.errors.has(
                                    _vm.payload.title.value
                                  ),
                                  expression: "errors.has(payload.title.value)"
                                }
                              ],
                              staticClass:
                                "material-icons form-control-feedback"
                      ...
                      _c(
                          ...
                          directives: [
                            {
                              name: "show",
                              rawName: "v-show",
                              value: _vm.errors.has(_vm.payload.title.value),
                              expression: "errors.has(payload.title.value)"
                            }
                          ],
                          staticClass: "help-block text-danger text-center"
                        ...
                        [
                          _c("strong", [
                            _vm._v(
                              _vm._s(_vm.errors.first(_vm.payload.title.value))
                            )
                          ])
                        ]
                      )
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                            ...
                            {
                              staticStyle: { display: "none" },
                              attrs: { id: "trans-subTitle" }
                            },
                            [
                              _vm._v(
                                _vm._s(_vm.trans(_vm.payload.subTitle.post))
                              )
                            ]
                          ),
                          _vm._v(" "),
                    ...
                    _c("div", { staticClass: "col-md-12" }, [
                      _c(
                        "div",
                        {
                          staticClass: "form-group label-floating",
                          class: {
                            "has-error": _vm.errors.has(_vm.payload.text.value)
                          }
                        },
                        [
                          _c("label", [_vm._v(_vm._s(_vm.payload.text.label))]),
                          _vm._v(" "),
                          _c(
                            "p",
                            {
                            ...
                            [_vm._v(_vm._s(_vm.trans(_vm.payload.text.post)))]
                          ),
                          _vm._v(" "),
                          _c("textarea", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.payload.text.post,
                                expression: "payload.text.post"
                              },
                              { name: "validate", rawName: "v-validate" }
                            ],
                            staticClass: "input form-control",
                            attrs: {
                              rows: "5",
                              name: _vm.payload.text.value,
                              "data-vv-rules": _vm.payload.text.rules,
                              "data-vv-validate-on": _vm.validateForm,
                              type: "text"
                            },
                            domProps: { value: _vm.payload.text.post },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                              ...
                              directives: [
                                {
                                  name: "show",
                                  rawName: "v-show",
                                  value: _vm.errors.has(_vm.payload.text.value),
                                  expression: "errors.has(payload.text.value)"
                                }
                              ],
                              staticClass:
                                "material-icons form-control-feedback"
                      ...
                      _c(
                        ...
                        [
                          _c("strong", [
                            _vm._v(
                              _vm._s(_vm.errors.first(_vm.payload.text.value))
                            )
                          ])
                        ]
                      )
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      ...
      [
        _c("h4", { staticClass: "title" }, [_vm._v("Edit Events")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-178d52ea", module.exports)
  }
}
