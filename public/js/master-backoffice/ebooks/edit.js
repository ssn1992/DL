 ...
 */
var formsComponent = __webpack_require__(391);
...
this.start = function () {
  if (!_isInit) {
    console.log("Edit Ebook area started..");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Forms_vue__ = __webpack_require__(392);
...
/* scopeId */
var __vue_scopeId__ = "data-v-5a550682"
/* moduleIdentifier (server only) */
...
Component.options.__file = "resources/assets/js/components/forms/request/backoffice/ebooks/edit/Forms.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5a550682", Component.options)
  } else {
    hotAPI.reload("data-v-5a550682", Component.options)
' + '  }
...
var update = __webpack_require__(3)("1854c123", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5a550682\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Forms.vue", function() {
     var newContent = require("!!../../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5a550682\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Forms.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        setEbookToEdit: function setEbookToEdit(response) {
            this.payload.id.post = response.ebook.id;
            this.payload.name.post = response.ebook.name;
            this.payload.details.post = response.ebook.details;
            this.payload.oldPdf.post = response.ebook.pdf;

            // Images
            this.payload.images.post = response.ebook.image;
            this.payload.images.alt = response.ebook.alt;
        ...
        editImage: function editImage() {
            ...
            payload.ebookId = this.payload.id.post;

            // Send a POST request
            axios({
                method: 'post',
                url: 'admin-area/edit-ebooks-image',
                data: payload
            }).then(function (response) {
        ...
        getEbook: function getEbook() {
            ...
            axios({
                method: 'post',
                url: 'admin-area/ebooks/actions/edit/' + payload.id,
                data: payload
            }).then(function (response) {
                self.customError = null;

                self.setEbookToEdit(response.data);
            }).catch(function (error) {
                self.customError = null;
                self.success = false;
        ...
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
            ...
            _c("div", { staticClass: "modal-body text-center" }, [
              _vm.success
                ? _c("p", [_vm._v("The ebook was successfully edit")])
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      ...
      [
        _c("h4", { staticClass: "title" }, [_vm._v("Edit Ebooks")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5a550682", module.exports)
  }
}
