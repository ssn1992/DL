 ...
 */
var formsComponent = __webpack_require__(427);
...
this.start = function () {
  if (!_isInit) {
    console.log("Edit Slider area started..");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Forms_vue__ = __webpack_require__(428);
...
/* scopeId */
var __vue_scopeId__ = "data-v-4674024c"
/* moduleIdentifier (server only) */
...
Component.options.__file = "resources/assets/js/components/forms/request/backoffice/sliders/edit/Forms.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4674024c", Component.options)
  } else {
    hotAPI.reload("data-v-4674024c", Component.options)
' + '  }
...
var update = __webpack_require__(3)("f0fb3472", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4674024c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Forms.vue", function() {
     var newContent = require("!!../../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4674024c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Forms.vue");
...
// module
exports.push([module.i, "\n.btn.disabled[data-v-4674024c], .btn[disabled][data-v-4674024c], fieldset[disabled] .btn[data-v-4674024c] {\n    cursor: auto;\n}\n.form-group .help-block[data-v-4674024c] {\n    display: block;\n}\nspan.check[data-v-4674024c]::after {\n    -webkit-animation: unset!important;\n            animation: unset!important;\n}\nspan.check form-control[data-v-4674024c]::after {\n    -webkit-animation: unset!important;\n            animation: unset!important;\n}\n@media (max-width: 480px), (max-width: 767px) {\n.form-group .form-control[data-v-4674024c] {\n        width: 100% !important;\n}\n}\n.card.card-shadow[data-v-4674024c] {\n    -webkit-box-shadow: 0 12px 20px -10px rgba(0, 0, 0, 0.12),\n    0 4px 20px 0px rgba(0, 0, 0, 0.12),\n    0 7px 8px -5px rgba(0, 0, 0, 0.12)!important;\n\n    box-shadow: 0 12px 20px -10px rgba(0, 0, 0, 0.12),\n    0 4px 20px 0px rgba(0, 0, 0, 0.12),\n    0 7px 8px -5px rgba(0, 0, 0, 0.12)!important;\n}\n\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        checkValidDate: function checkValidDate() {
            ...
            if (date.todayDate > date.dateFrom || date.todayDate > date.dateTo || date.dateFrom > date.dateTo || date.dateFrom === 'Invalid date' || date.dateTo === 'Invalid date') {
        ...
        validateBeforeSubmit: function validateBeforeSubmit() {
            ...
            this.$validator.validateAll().then(function (result) {
                if (result && _this.checkValidDate(window.moment($('#begin-date').val()), window.moment($('#end-date').val()))) {
        ...
        editImage: function editImage() {
            ...
            payload.sliderId = this.payload.id.post;

            // Send a POST request
            axios({
                method: 'post',
                url: 'admin-area/edit-sliders-image',
                data: payload
        ...
        setSliderToEdit: function setSliderToEdit(response) {
            this.payload.id.post = response.slider.id;
            this.payload.name.post = response.slider.name;
            this.payload.page.post = response.slider.page;
            this.payload.details.post = response.slider.details;
            this.payload.btnLink.post = response.slider.btnLink;
            this.payload.btnText.post = response.slider.btnText;
            this.payload.beginDate.post = moment(response.slider.beginDate).format('YYYY-MM-DD');
            this.payload.endDate.post = moment(response.slider.endDate).format('YYYY-MM-DD');

            // Images
            this.payload.images.post = response.slider.image;
            this.payload.images.alt = response.slider.alt;
        ...
        getSlider: function getSlider() {
            ...
            axios({
                method: 'post',
                url: 'admin-area/sliders/actions/edit/' + payload.id,
                data: payload
            }).then(function (response) {
                self.customError = null;

                self.setSliderToEdit(response.data);
            }).catch(function (error) {
                self.customError = null;
                self.success = false;
        ...
        getLanguagesList: function getLanguagesList() {
            var self = this;
        ...
        getPagesList: function getPagesList() {
            var self = this;
        ...
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
            ...
            _c("div", { staticClass: "modal-body text-center" }, [
              _vm.success
                ? _c("p", [_vm._v("The slider was successfully added")])
                  ...
                  _c("div", { staticClass: "row" }, [
                    _c("div", { staticClass: "col-md-12" }, [
                      _c(
                        ...
                        [
                          _c("label", [_vm._v(_vm._s(_vm.payload.name.label))]),
                          _vm._v(" "),
                          _c(
                            "p",
                            {
                            ...
                            [_vm._v(_vm._s(_vm.trans(_vm.payload.name.post)))]
                          ),
                          _vm._v(" "),
                          _c("input", {
                            directives: [
                    ...
                    _c("div", { staticClass: "col-md-6" }, [
                      _c(
                        "div",
                        {
                          ...
                          class: {
                            "has-error": _vm.errors.has(
                              _vm.payload.btnLink.value
                            )
                          }
                        },
                        [
                          _c("label", [
                            _vm._v(_vm._s(_vm.payload.btnLink.label))
                          ]),
                          _vm._v(" "),
                          _c(
                            "p",
                            {
                              staticStyle: { display: "none" },
                              attrs: { id: "btnLink-trans" }
                            },
                            [
                              _vm._v(
                                _vm._s(_vm.trans(_vm.payload.btnLink.post))
                              )
                            ]
                          ),
                          _vm._v(" "),
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.payload.btnLink.post,
                                expression: "payload.btnLink.post"
                              },
                              { name: "validate", rawName: "v-validate" }
                            ],
                            staticClass: "input form-control",
                            attrs: {
                              name: _vm.payload.btnLink.value,
                              "data-vv-rules": _vm.payload.btnLink.rules,
                              "data-vv-validate-on": _vm.validateForm,
                              type: "text"
                            },
                            domProps: { value: _vm.payload.btnLink.post },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                              ...
                              directives: [
                                {
                                  ...
                                  expression:
                                    "errors.has(payload.btnLink.value)"
                                }
                              ],
                              staticClass:
                                "material-icons form-control-feedback"
                      ...
                      _c(
                          ...
                          directives: [
                            {
                              name: "show",
                              rawName: "v-show",
                              value: _vm.errors.has(_vm.payload.btnLink.value),
                              expression: "errors.has(payload.btnLink.value)"
                            }
                          ],
                          staticClass: "help-block text-danger text-center"
                        },
                        [
                          _c("strong", [
                            _vm._v(
                              _vm._s(
                                _vm.errors.first(_vm.payload.btnLink.value)
                              )
                            )
                          ])
                        ]
                    ...
                    _c("div", { staticClass: "col-md-6" }, [
                      _c(
                        "div",
                        {
                          ...
                          class: {
                            "has-error": _vm.errors.has(
                              _vm.payload.btnText.value
                            )
                          }
                        },
                        [
                          _c("label", [
                            _vm._v(_vm._s(_vm.payload.btnText.label))
                          ]),
                          _vm._v(" "),
                          _c(
                            "p",
                            {
                              staticStyle: { display: "none" },
                              attrs: { id: "btnText-trans" }
                            },
                            [
                              _vm._v(
                                _vm._s(_vm.trans(_vm.payload.btnText.post))
                              )
                            ]
                          ),
                          _vm._v(" "),
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.payload.btnText.post,
                                expression: "payload.btnText.post"
                              },
                              { name: "validate", rawName: "v-validate" }
                            ],
                            staticClass: "input form-control",
                            attrs: {
                              name: _vm.payload.btnText.value,
                              "data-vv-rules": _vm.payload.btnText.rules,
                              "data-vv-validate-on": _vm.validateForm,
                              type: "text"
                            },
                            domProps: { value: _vm.payload.btnText.post },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                              ...
                              directives: [
                                {
                                  ...
                                  expression:
                                    "errors.has(payload.btnText.value)"
                                }
                              ],
                              staticClass:
                                "material-icons form-control-feedback"
                      ...
                      _c(
                          ...
                          directives: [
                            {
                              name: "show",
                              rawName: "v-show",
                              value: _vm.errors.has(_vm.payload.btnText.value),
                              expression: "errors.has(payload.btnText.value)"
                            }
                          ],
                          staticClass: "help-block text-danger text-center"
                        },
                        [
                          _c("strong", [
                            _vm._v(
                              _vm._s(
                                _vm.errors.first(_vm.payload.btnText.value)
                              )
                            )
                          ])
                        ]
                        ...
                        _c("div", { staticClass: "col-md-6" }, [
                          _c(
                            "div",
                            {
                              ...
                              class: {
                                "has-error": _vm.errors.has(
                                  _vm.payload.beginDate.value
                                )
                              }
                            },
                            [
                              _c("label", [
                                _vm._v(_vm._s(_vm.payload.beginDate.label))
                              ]),
                              _vm._v(" "),
                              _c("input", {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.payload.beginDate.post,
                                    expression: "payload.beginDate.post"
                                  },
                                  { name: "validate", rawName: "v-validate" }
                                ],
                                staticClass: "input form-control datepicker",
                                attrs: {
                                  id: "begin-date",
                                  name: _vm.payload.beginDate.value,
                                  "data-vv-rules": _vm.payload.beginDate.rules,
                                  "data-vv-validate-on": _vm.validateForm,
                                  type: "text"
                                },
                                domProps: { value: _vm.payload.beginDate.post },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
                                  ...
                                  directives: [
                                    {
                                      ...
                                      expression:
                                        "errors.has(payload.beginDate.value)"
                                    }
                                  ],
                                  staticClass:
                                    "material-icons form-control-feedback"
                        ...
                        _c("div", { staticClass: "col-md-6" }, [
                          _c(
                            "div",
                            {
                              ...
                              class: {
                                "has-error": _vm.errors.has(
                                  _vm.payload.endDate.value
                                )
                              }
                            },
                            [
                              _c("label", [
                                _vm._v(_vm._s(_vm.payload.endDate.label))
                              ]),
                              _vm._v(" "),
                              _c("input", {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.payload.endDate.post,
                                    expression: "payload.endDate.post"
                                  },
                                  { name: "validate", rawName: "v-validate" }
                                ],
                                staticClass: "input form-control datepicker",
                                attrs: {
                                  id: "end-date",
                                  name: _vm.payload.endDate.value,
                                  "data-vv-rules": _vm.payload.endDate.rules,
                                  "data-vv-validate-on": _vm.validateForm,
                                  type: "text"
                                },
                                domProps: { value: _vm.payload.endDate.post },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
                                  ...
                                  directives: [
                                    {
                                      ...
                                      expression:
                                        "errors.has(payload.endDate.value)"
                                    }
                                  ],
                                  staticClass:
                                    "material-icons form-control-feedback"
                          ...
                          _c(
                            ...
                            [
                              _c("strong", [
                                _vm._v(
                                  _vm._s(
                                    _vm.errors.first(_vm.payload.endDate.value)
                                  )
                                )
                              ])
                            ]
                            ...
                            [
                              _c(
                                "div",
                                {
                                  ...
                                  attrs: {
                                    id: "image-nav-" + _vm.payload.id.post
                                  }
                                },
                                [
                                  _c("label", {
                                  ...
                                  _c("div", [
                                    ...
                                    _vm._v(
                                      "\n                                                        " +
                                        _vm._s(
                                          _vm.trans(_vm.payload.images.alt)
                                        ) +
                                        "\n                                                        "
                                    ),
                                    _c(
                            ...
                            [
                              _c("div", { staticClass: "title" }, [
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      " " + _vm._s(_vm.payload.page.label) + " "
                                    )
                                  ]
                                )
                              ]),
                              _vm._v(" "),
                              _vm._l(_vm.payload.page.data, function(data) {
                                return _c(
                                  "div",
                                  {
                                    staticClass:
                                    ...
                                    _c("div", { staticClass: "radio" }, [
                                      _c("label", [
                                        _c("input", {
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model",
                                              value: _vm.payload.page.post,
                                              expression: "payload.page.post"
                                            },
                                            {
                                              name: "validate",
                                              rawName: "v-validate"
                                          ...
                                          attrs: {
                                            type: "radio",
                                            name: _vm.payload.page.value,
                                            "data-vv-rules":
                                              _vm.payload.page.rules,
                                            "data-vv-validate-on":
                                              _vm.validateForm
                                          },
                                          domProps: {
                      ...
                      _c("div", { staticClass: "form-group" }, [
                        _c(
                          "div",
                          {
                            ...
                            class: {
                              "has-error": _vm.errors.has(
                                _vm.payload.details.value
                              )
                            }
                          },
                          [
                            _c("label", [
                              _vm._v(" " + _vm._s(_vm.payload.details.label))
                            ]),
                            _vm._v(" "),
                            _c(
                              "p",
                              {
                                staticStyle: { display: "none" },
                                attrs: { id: "details-trans" }
                              },
                              [
                                _vm._v(
                                  _vm._s(_vm.trans(_vm.payload.details.post))
                                )
                              ]
                            ),
                            _vm._v(" "),
                            _c("textarea", {
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.payload.details.post,
                                  expression: "payload.details.post"
                                },
                                { name: "validate", rawName: "v-validate" }
                              ],
                              staticClass: "input form-control",
                              attrs: {
                                rows: "5",
                                name: _vm.payload.details.value,
                                "data-vv-rules": _vm.payload.details.rules,
                                "data-vv-validate-on": _vm.validateForm
                              },
                              domProps: { value: _vm.payload.details.post },
                              on: {
                                input: function($event) {
                                  if ($event.target.composing) {
                                    return
                                ...
                                directives: [
                                  {
                                    ...
                                    expression:
                                      "errors.has(payload.details.value)"
                                  }
                                ],
                                staticClass:
                                  "material-icons form-control-feedback"
                      ...
                      _c(
                          ...
                          directives: [
                            {
                              name: "show",
                              rawName: "v-show",
                              value: _vm.errors.has(_vm.payload.details.value),
                              expression: "errors.has(payload.details.value)"
                            }
                          ],
                          staticClass: "help-block text-danger text-center"
                        },
                        [
                          _c("strong", [
                            _vm._v(
                              _vm._s(
                                _vm.errors.first(_vm.payload.details.value)
                              )
                            )
                          ])
                        ]
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      ...
      [
        _c("h4", { staticClass: "title" }, [_vm._v("Edit Sliders")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4674024c", module.exports)
  }
}
