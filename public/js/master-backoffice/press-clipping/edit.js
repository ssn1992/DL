 ...
 */
var formsComponent = __webpack_require__(481);
...
this.start = function () {
  if (!_isInit) {
    console.log("Edit Press Clipping area started..");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Forms_vue__ = __webpack_require__(482);
...
/* scopeId */
var __vue_scopeId__ = "data-v-b35dcd90"
/* moduleIdentifier (server only) */
...
Component.options.__file = "resources/assets/js/components/forms/request/backoffice/press-clipping/edit/Forms.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b35dcd90", Component.options)
  } else {
    hotAPI.reload("data-v-b35dcd90", Component.options)
' + '  }
...
var update = __webpack_require__(3)("0e389c0f", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b35dcd90\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Forms.vue", function() {
     var newContent = require("!!../../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b35dcd90\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Forms.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        setPressClippingToEdit: function setPressClippingToEdit(response) {
            this.payload.id.post = response.clipping.id;
            this.payload.name.post = response.clipping.name;
            this.payload.details.post = response.clipping.details;
            this.payload.cover.post = response.clipping.cover;

            // Images
            this.payload.images.post = response.clipping.image;
            this.payload.images.alt = response.clipping.alt;
        ...
        getPressClipping: function getPressClipping() {
            var self = this;
            ...
            axios({
                method: 'post',
                url: 'admin-area/press-clipping/actions/edit/' + payload.id,
                data: payload
            }).then(function (response) {
                self.customError = null;

                self.setPressClippingToEdit(response.data);
        ...
        editPressClipping: function editPressClipping() {
            ...
            axios({
                method: 'post',
                url: 'admin-area/edit-press-clipping',
                data: payload
            }).then(function () {
        ...
        editImage: function editImage() {
            ...
            payload.clippingId = this.payload.id.post;

            // Send a POST request
            axios({
                method: 'post',
                url: 'admin-area/edit-press-clipping-image',
                data: payload
            }).then(function (response) {
                window.location.href = window.location.pathname;
            }).catch(function (error) {
        ...
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
            ...
            _c("div", { staticClass: "modal-body text-center" }, [
              _vm.success
                ? _c("p", [
                    _vm._v("The Press Clipping was successfully edited")
                  ])
                          ...
                          _c("div", { staticClass: "col-lg-3" }, [
                            _c("div", { staticClass: "checkbox" }, [
                              _c("label", [
                                  ...
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.payload.cover.post,
                                      expression: "payload.cover.post"
                                    }
                                  ],
                                  attrs: {
                                    type: "checkbox",
                                    name: _vm.payload.cover.value,
                                    "data-vv-validate-on": _vm.validateForm
                                  },
                                  domProps: {
                                    checked: Array.isArray(
                                      _vm.payload.cover.post
                                    )
                                      ? _vm._i(_vm.payload.cover.post, null) >
                                        -1
                                      : _vm.payload.cover.post
                                  },
                                  on: {
                                    change: function($event) {
                                      var $$a = _vm.payload.cover.post,
                                        $$el = $event.target,
                                      ...
                                      if (Array.isArray($$a)) {
                                        ...
                                        if ($$el.checked) {
                                          $$i < 0 &&
                                            (_vm.payload.cover.post = $$a.concat(
                                              [$$v]
                                            ))
                                        } else {
                                          $$i > -1 &&
                                            (_vm.payload.cover.post = $$a
                                              .slice(0, $$i)
                                              .concat($$a.slice($$i + 1)))
                                        }
                                      } else {
                                        _vm.$set(_vm.payload.cover, "post", $$c)
                                      }
                                    }
                                  }
                                }),
                                _vm._v(
                                  "\n                                                " +
                                    _vm._s(_vm.payload.cover.label) +
                                    "\n                                            "
                                )
                              ])
                            ])
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      ...
      [
        _c("h4", { staticClass: "title" }, [_vm._v("Edit Press Clipping")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b35dcd90", module.exports)
  }
}
