 ...
 */
var formsComponent = __webpack_require__(553);
...
this.start = function () {
  if (!_isInit) {
    console.log("Edit Catalogue area started..");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Forms_vue__ = __webpack_require__(554);
...
/* scopeId */
var __vue_scopeId__ = "data-v-47122516"
/* moduleIdentifier (server only) */
...
Component.options.__file = "resources/assets/js/components/forms/request/backoffice/catalogue/edit/Forms.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-47122516", Component.options)
  } else {
    hotAPI.reload("data-v-47122516", Component.options)
' + '  }
...
var update = __webpack_require__(3)("1f714ec3", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-47122516\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Forms.vue", function() {
     var newContent = require("!!../../../../../../../../../node_modules/css-loader/index.js!../../../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-47122516\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Forms.vue");
...
// module
exports.push([module.i, "\n.btn.disabled[data-v-47122516], .btn[disabled][data-v-47122516], fieldset[disabled] .btn[data-v-47122516] {\n    cursor: auto;\n}\n.form-group .help-block[data-v-47122516] {\n    display: block;\n}\nspan.check[data-v-47122516]::after {\n    -webkit-animation: unset!important;\n            animation: unset!important;\n}\nspan.check form-control[data-v-47122516]::after {\n    -webkit-animation: unset!important;\n            animation: unset!important;\n}\n@media (max-width: 480px), (max-width: 767px) {\n.form-group .form-control[data-v-47122516] {\n        width: 100% !important;\n}\n}\n.card.card-shadow[data-v-47122516] {\n    -webkit-box-shadow: 0 12px 20px -10px rgba(0, 0, 0, 0.12),\n    0 4px 20px 0px rgba(0, 0, 0, 0.12),\n    0 7px 8px -5px rgba(0, 0, 0, 0.12)!important;\n\n    box-shadow: 0 12px 20px -10px rgba(0, 0, 0, 0.12),\n    0 4px 20px 0px rgba(0, 0, 0, 0.12),\n    0 7px 8px -5px rgba(0, 0, 0, 0.12)!important;\n}\n\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        setCatalogueToEdit: function setCatalogueToEdit(response) {
            this.payload.id.post = response.catalogue.id;
            this.payload.name.post = response.catalogue.name;
            this.payload.link.post = response.catalogue.link;

            // Images
            this.payload.images.post = response.catalogue.image;
            this.payload.images.alt = response.catalogue.alt;

            // PDF
            this.payload.oldPdf.post = response.catalogue.pdf;

            this.$nextTick(function () {
                this.payload.name.post = $('#name-trans').text();
                this.payload.link.post = $('#link-trans').text();
        ...
        editImage: function editImage() {
            ...
            payload.catalogueId = this.payload.id.post;

            // Send a POST request
            axios({
                method: 'post',
                url: 'admin-area/edit-catalogue-image',
                data: payload
        ...
        getCatalogue: function getCatalogue() {
            ...
            axios({
                method: 'post',
                url: 'admin-area/catalogue/actions/edit/' + payload.id,
                data: payload
            }).then(function (response) {
                self.setCatalogueToEdit(response.data);
        ...
        editCatalogue: function editCatalogue() {
        ...
        _c("div", { staticClass: "modal-dialog" }, [
          _c("div", { staticClass: "modal-content" }, [
            ...
            _c("div", { staticClass: "modal-body text-center" }, [
              _vm.success
                ? _c("p", [_vm._v("The Catalogue was successfully added")])
                    ...
                    _c("div", { staticClass: "col-md-12" }, [
                      _c(
                        "div",
                        {
                          staticClass: "form-group label-floating",
                          class: {
                            "has-error": _vm.errors.has(_vm.payload.link.value)
                          }
                        },
                        [
                          _c("label", [_vm._v(_vm._s(_vm.payload.link.label))]),
                          _vm._v(" "),
                          _c(
                            "p",
                            {
                            ...
                            [_vm._v(_vm._s(_vm.trans(_vm.payload.link.post)))]
                          ),
                          _vm._v(" "),
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.payload.link.post,
                                expression: "payload.link.post"
                              },
                              { name: "validate", rawName: "v-validate" }
                            ],
                            staticClass: "input form-control",
                            attrs: {
                              name: _vm.payload.link.value,
                              "data-vv-rules": _vm.payload.link.rules,
                              "data-vv-validate-on": _vm.validateForm,
                              type: "text"
                            },
                            domProps: { value: _vm.payload.link.post },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                              ...
                              directives: [
                                {
                                  name: "show",
                                  rawName: "v-show",
                                  value: _vm.errors.has(_vm.payload.link.value),
                                  expression: "errors.has(payload.link.value)"
                                }
                              ],
                              staticClass:
                                "material-icons form-control-feedback"
                      ...
                      _c(
                        ...
                        [
                          _c("strong", [
                            _vm._v(
                              _vm._s(_vm.errors.first(_vm.payload.link.value))
                            )
                          ])
                        ]
                      )
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      ...
      [
        _c("h4", { staticClass: "title" }, [_vm._v("Edit Catalogue")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-47122516", module.exports)
  }
}
