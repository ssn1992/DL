            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <p v-if="success">The slider was successfully added</p>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header" data-background-color="red">
                            <h4 class="title">Edit Sliders</h4>
                        ...
                        <div class="card-content">
                            <form @submit.prevent="validateBeforeSubmit()" id="form-section-projects" enctype='multipart/form-data'>
                                ...
                                <div class="row" v-if="payload.language.post === 'en'">
                                    <div class="col-sm-12">
                                        <div class="form-group" :class="{'has-error': errors.has(payload.page.value)}">
                                            ...
                                            <div class="col-lg-12">
                                                <span v-show="errors.has(payload.page.value)" class="help-block text-danger text-center radio-button-error" style="width: 100%">
                                ...
                                <button type="submit" class="btn btn-primary pull-right ladda-button" data-style="expand-right">Edit Slider</button>
