                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <form @submit.prevent="validateBeforeSubmit()" id="form-section-projects" enctype='multipart/form-data'>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group label-floating" :class="{'has-error': errors.has(payload.btnLink.value)}">
                                            <label class="control-label">{{ payload.btnLink.label }}</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group label-floating" :class="{'has-error': errors.has(payload.btnText.value)}">
                                            <label class="control-label">{{ payload.btnText.label }}</label>
                                ...
                                <button type="submit" class="btn btn-primary pull-right ladda-button" data-style="expand-right">Add Slider</button>
