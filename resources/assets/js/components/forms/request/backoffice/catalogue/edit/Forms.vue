            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <p v-if="success">The Catalogue was successfully added</p>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header" data-background-color="red">
                            <h4 class="title">Edit Catalogue</h4>
                        ...
                        <div class="card-content">
                            <form @submit.prevent="validateBeforeSubmit()" id="form-section-projects" enctype='multipart/form-data'>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group label-floating" :class="{'has-error': errors.has(payload.link.value)}">
                                            <label>{{ payload.link.label }}</label>
                                            <p id="link-trans" style="display: none">{{ trans(payload.link.post) }}</p>

                                            <input v-model="payload.link.post" :name=payload.link.value  v-validate :data-vv-rules=payload.link.rules :data-vv-validate-on="validateForm" type="text" class="input form-control">
                                            <span v-show="errors.has(payload.link.value)" class="material-icons form-control-feedback">clear</span>
                                        </div>
                                        <span v-show="errors.has(payload.link.value)" class="help-block text-danger text-center">
                                            <strong>{{ errors.first(payload.link.value) }}</strong>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <button type="submit" class="btn btn-primary pull-right ladda-button" data-style="expand-right">Edit Catalogue</button>
