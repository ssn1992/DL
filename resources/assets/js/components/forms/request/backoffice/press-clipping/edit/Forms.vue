            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                            <p v-if="success">The Press Clipping was successfully edited</p>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header" data-background-color="red">
                            <h4 class="title">Edit Press Clipping</h4>
                        ...
                        <div class="card-content">
                            <form @submit.prevent="validateBeforeSubmit()" id="form-section-projects" enctype='multipart/form-data'>
                                ...
                                <div class="row" v-if="payload.language.post === 'en'">
                                    <div class="form-group">
                                        <div class="col-lg-3">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" v-model="payload.cover.post" :name=payload.cover.value :data-vv-validate-on="validateForm">
                                                    {{ payload.cover.label }}
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <button type="submit" class="btn btn-primary pull-right ladda-button" data-style="expand-right">Edit Press Clipping</button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            setPressClippingToEdit (response) {
