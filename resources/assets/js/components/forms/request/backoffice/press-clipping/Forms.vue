            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                            <p v-if="success">The Press Clipping was successfully added</p>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header" data-background-color="red">
                            <h4 class="title">Add Press Clipping</h4>
                        ...
                        <div class="card-content">
                            <form @submit.prevent="validateBeforeSubmit()" id="form-section-projects" enctype='multipart/form-data'>
                                ...
                                <div class="row">
                                    ...
                                    <button type="submit" class="btn btn-primary pull-right ladda-button" data-style="expand-right">Add Press Clipping</button>
