            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <p v-if="success">The project was successfully added</p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <form @submit.prevent="validateBeforeSubmit()" id="form-section-projects" enctype='multipart/form-data'>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group label-floating" :class="{'has-error': errors.has(payload.autor.value)}">
                                            <label class="control-label">{{ payload.autor.label }}</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group label-floating" :class="{'has-error': errors.has(payload.location.value)}">
                                            <label class="control-label">{{ payload.location.label }}</label>
                                ...
                                <button type="submit" class="btn btn-primary pull-right ladda-button" data-style="expand-right">Add Project</button>
