            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <p v-if="success">The ebook was successfully added</p>
                        ...
                        <div class="card-content">
                            <form @submit.prevent="validateBeforeSubmit()" id="form-section-projects" enctype='multipart/form-data'>
                                ...
                                <div class="row">
                                    ...
                                    <button type="submit" class="btn btn-primary pull-right ladda-button" data-style="expand-right">Add Ebook</button>
